...
//Devolver un listado de ususarios paginados
...
function uploadImage(req,res){
    ...
    if(req.files){
        ...
        if(userId!=req.user.sub){
            return removeFilesOfUploads(res,file_path,'No tienes permiso para actualizar los datos del ususario');
            
        }
        
        if(file_ext=='png' || file_ext=='jpg' || file_ext=='jpeg' || file_ext=='gif'){
            //Actualizo documento del usuario logeado
